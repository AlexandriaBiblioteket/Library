...
insert into media values (100000, 'Java: Learn Java in One Day and Learn It Well.', '9781539397830', 1, 1, "BOOK");

insert into author values (2, 'Kathy Sierra');
insert into media values (100001, 'Head First Java, 2nd Edition', '9780596009205', 1, 2, "BOOK");

insert into author values (3, 'Herbert Schildt');
insert into media values (100002, 'Java: The Complete Reference, Ninth Edition', '9780071808552', 1, 3, "BOOK");

insert into author values (4, 'Steve Tale');
insert into media values (100003, 'Java: The Ultimate Beginners Guide to Java Programming', '9781539591214', 1, 4, "BOOK");
insert into media values (100004, 'JavaScript: The Ultimate Beginners Guide', '9781539984634', 1, 4, "BOOK");
insert into media values (100005, 'SQL: The Ultimate Beginners Guide - Learn SQL Today', '9781533604569', 1, 4, "BOOK");

insert into author values (5, 'John Joseph Stockdale');
insert into media values (100006, 'Island of Java (Periplus Classics Series)', '9789628734238', 1, 5, "BOOK");

insert into author values (6, 'John MacKinnon');
insert into media values (100007, 'A Field Guide to the Birds of Borneo, Sumatra, Java, and Bali: The Greater Sunda Islands', '9780198540342', 1, 6, "BOOK");

insert into author values (7, 'Dian Pramesti');
insert into media values (100008, 'Greater Than a Tourist – Java, Indonesia: 50 Travel Tips from a Local', '9781521199466', 1, 7, "BOOK");

insert into author values (8, 'Jeffrey E. F. Friedl');
insert into media values (100009, 'Mastering Regular Expressions', '9780596528126', 1, 8, "BOOK");
